var extract = function (namefile, _config) {
  ...
  if(namefile !== undefined)
      return requirecomponente(namefile);

  function requirecomponente(file){
    ...
    if(type === "vue"){
        ...
        return config.babel_compiler.options.vue.lenth > 0 ?
            babel.transform(`Vue.component('${component_name}',
            ${componentsvue[component_name]});
            ${componentsvue[component_name + "subcomponents"] === undefined ? '' : componentsvue[component_name + "subcomponents"]}`, config.babel_compiler.options.vue).code :
            `Vue.component('${component_name}',
            ${componentsvue[component_name]});
            ${componentsvue[component_name + "subcomponents"] === undefined ? '' : componentsvue[component_name + "subcomponents"]}`;
    }
        ...
        return componentsreact[component_name];
    }
  }
  ...
  function run (){
      ...
      fs.readdir("./"+config.components_folder, (err, files) => {
              ...
              part_files = part_files.replace(/<{(.*?)}\/>/gi, function (x,y){
                  ...
                  if(componentsvue[y] !== undefined){
                      ...
                      return config.babel_compiler.options.vue.lenth > 0 ?
                          ...
                          ${componentsvue[y]});
                          ${componentsvue[y + "subcomponents"] === undefined ? '' : componentsvue[y + "subcomponents"]}`, config.babel_compiler.options.vue).code :
                          `Vue.component('${y}',
                          ${componentsvue[y]});
                          ${componentsvue[y + "subcomponents"] === undefined ? '' : componentsvue[y + "subcomponents"]}`;
                  }
          ...
          fs.writeFileSync(config.globalPath + "/" + config.build_Script.save_folder + config.build_Script.name, imports(final_file, 2));
