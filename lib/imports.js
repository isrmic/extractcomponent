...
function importmodules (filetext, typerender, _config, road){
  // if(arguments[4])
      ...
      if(res !== null){
          ...
          importers.map(Import =>{
              ...
              if(typeimportvar === "blc"){
                  ...
                  prop_vars = _blocksctx.map(res => `\nvar ${res} = _getModule_${fileload.replace(/[^a-zA-Z /]|'|"|\//g, "_")}()["${res}"];`);
              }
              else{
              ...
              if(fileload !== undefined && /{<(.*?)\/>}/i.test(fileload)){
                  ...
                  if(extension === ".html" || extension === ".pug" || extension === ".jade" || extension === ".vue" || extension === ".react"){
                      ...
                      if(fs.existsSync(path.join(_path, 'node_modules', fileload)) || fs.existsSync(path.join(_path, 'node_modules', fileload + ".js"))){
                          ...
                          requirefile = requiremodule(`require('${fileload}')`, _path, 2);
